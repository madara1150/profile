...
export default function EditProjectPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    // Use `use` hook to unwrap the Promise-wrapped `params` correctly for React 19/Next 15
    ...
    useEffect(() => {
        const fetchProject = async () => {
            try {
                ...
                // Initialize tags/images as empty arrays if null
                setForm({
                    ...data,
                    tags: data.tags || [],
                    images: data.images || [],
    ...
    if (isFetchingInitialData) {
        return (
            <div className="max-w-4xl mx-auto py-20 flex flex-col items-center justify-center text-muted-foreground animate-pulse">
